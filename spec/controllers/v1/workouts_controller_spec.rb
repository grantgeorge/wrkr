...
RSpec.describe V1::WorkoutsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved workout as @workout' do
        post :create, { workout: invalid_attributes }, valid_session
        expect(assigns(:workout)).to be_a_new(Workout)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested workout' do
        workout = Workout.create! valid_attributes
        put :update, { id: workout.to_param, workout: new_attributes }, valid_session
        workout.reload
    ...
    context 'with invalid params' do
      it 'assigns the workout as @workout' do
        workout = Workout.create! valid_attributes
        put :update, { id: workout.to_param, workout: invalid_attributes }, valid_session
        expect(assigns(:workout)).to eq(workout)
      end
